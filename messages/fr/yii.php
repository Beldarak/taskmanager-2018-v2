...
return [
    ' and ' => ' et ',
    '"{attribute}" does not support operator "{operator}".' => '"{attrubute}" ne supporte pas l\'opérateur "{operator}"',
    '(not set)' => '(indéfini)',
    ...
    'Delete' => 'Supprimer',
    'Error' => 'Erreur',
    'File upload failed.' => 'L\'upload du fichier a échoué',
    'Home' => 'Accueil',
    'Invalid data received for parameter "{param}".' => 'Données invalides reçues pour le paramètre "{param}"',
